...
> 500 times. Friendships are 1000 (users \* average friendships) and calling `addFriendship()` create 2 friends, one on each side of the relationship.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

> From my tests, it's about 98.5%. Average degree is about 5.
...
> My first implementation was O(n). I'm not sure what the downside to it would be, actually.
